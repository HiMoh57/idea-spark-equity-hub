...
import { Eye, Heart, DollarSign, MessageSquare, Bell, Edit, Trash2 } from 'lucide-react';
      ...
      <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-600">Manage your ideas and track their performance</p>
          </div>
